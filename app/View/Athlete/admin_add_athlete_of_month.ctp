...
<div class="faqs row">
    <div class="floatleft mtop10"><h2><?php echo __('Select athlete of the month'); ?></h2></div>
    
    <div class="floatright">
        <?php
		echo $this->Html->link('<span>'.__('Back').'</span>', array('controller' => 'athlete','action' => 'admin_athlete_of_month'),array('class'=>'black_btn','escape'=>false));?>
	</div>
...
<div align="center" class="whitebox mtop15">
    ...
    <table cellspacing="0" cellpadding="7" border="0" align="center">
		...
		<tr>
			<td align="left"><strong class="upper">Athlete</strong></td>
			<td align="left">
				<?php 
				echo $this->Form->input('user_id',array('type' => 'hidden'));
				echo $this->Form->input('user_name',array('type' => 'text','class' => 'input required', 'label' => false, 'div' => false));?>	
			</td>
		</tr>
...
$(document).ready(function(){
	...
	var availableTags = <?php echo $athletes; ?>;
		
	$( "#PersonOfMonthUserName" ).autocomplete({
			 source: "<?php echo $this->webroot.'admin/athlete/get_all_athletes'; ?>",
			 focus: function( event, ui ) {
					$( "#PersonOfMonthUserName" ).val( ui.item.label );
					$( "#PersonOfMonthUserId" ).val( ui.item.value );
				return false;
			},

<div class="faqs index">
    <h2><?php echo __('Manage athlete of the month for Year - '.$year);?></h2>
	...
	echo $this->Form->create(
			null, array(
				'url' => array('controller' => 'athlete', 
					'action' => 'admin_athlete_of_month'),
					'inputDefaults' => array(
							'label' => false,
							'div' => false
						),
					...
					<table cellspacing="0" cellpadding="4" border="0">
						<tr valign="top">
							...
							<td valign="middle" align="left" style="width:100%">
								...
								<?php
								echo $this->Html->link('<span>'.__('Add athlete of the month').'</span>', array('controller' => 'athlete','action' => 'admin_add_athlete_of_month'),array('class'=>'black_btn floatRight','escape'=>false));
								?>
								</div>
							</td>
						</tr>
    ...
    <div class="row mtop30">
	    ...
	    <?php $i=1;
			...
			<tr>
				...
				<td align="left" valign="middle"><?php if(isset($dat['User']['AthleteProfile']['Region']['name']))
																	echo $dat['User']['AthleteProfile']['Region']['name'];	
														else echo 'N/A';  ?></td>
				
				<td align="center">
				<?php 
			
					echo $this->Html->link($this->Html->image(ADMIN_IMAGES_PATH.'trash.gif'), array('action' => 'delete_athlete_of_month', $dat['PersonOfMonth']['id']),array('escape'=>false), __('Are you sure you want to delete # %s?', $dat['PersonOfMonth']['id']));

	...
	<section class="athlt-profile-top row">
		<div class="page-mid">
			<div class="filter-search row">
				...
				<?php echo $this->Form->create('searchForm',array('url'=>array('controller'=>'affiliate','action'=>'add_athlete'),'type'=>'get')); ?>
						...
						<div class="column">
							...
							<div class="header">
								...
								<div class="blue save-btn">								
                                  <button onclick="window.location='<?php echo $this->webroot.'affiliate/add_new_athlete'; ?>'">Add New Athlete</button>
								</div>
							</div>
						</div>
					</div>	
								...
								<?php 
									...
									<tr>
										...
										<td>					
											...
											<a href="<?php echo $this->webroot.'affiliate/connect_athlete/'.$ev['User']['id']; ?>">Invite</a>
											<?php  }else{ ?>
												<span>Invited</span>
											<?php } ?>										

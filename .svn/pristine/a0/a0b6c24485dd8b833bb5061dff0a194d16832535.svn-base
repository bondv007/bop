						...
						<div class="column">
							<div class="header">
								...
								<div class="blue save-btn">								
                                  <div class="submit">																 
										<div class="blue">
												<button onclick="window.location.href='<?php echo $this->webroot.'affiliate/add_badge'; ?>'" type="submit" style="float:right;">Add Badge</button>
										 </div>
									</div>  
								</div>								  
							...
							?>
								...
								<?php 
									...
									<tr>
										...
										<td><?php echo $this->Html->link('Remove', array('controller' => 'affiliate','action' => 'delete_badge', $ev['Badge']['id']),array('escape'=>false), __('Are you sure you want to delete # %s?', $ev['Badge']['id'])); ?>
				</td>				
									</tr>
									<?php $i++; }}else{ ?>

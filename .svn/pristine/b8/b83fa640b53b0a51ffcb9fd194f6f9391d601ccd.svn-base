...
<div align="center" class="whitebox mtop15">
    ...
    <table cellspacing="0" cellpadding="7" border="0" align="center" width="450">
		...
		<?php if(!empty($this->request->data['Wod']['adjusted_criteria']) || isset($data)){ ?>
			<tr>
		...
		<td colspan="2">
			...
			<div id="TextBoxesGroup">
				...
				<?php if ( !isset($data) ){  
						...
						foreach($wod_movements as $wdm) {
					?>
				<div id="movementsDataBoxHtml1" class="mboxes">
					<table>
						<tr>
							<td align="left"><strong class="upper">movements</strong></td>
							<td align="left"><?php	echo $this->Form->input('movement_category][',array('type'=>'select', 'class' => 'input', 'options' => $movements, 'selected' => $wdm['WodMovement']['movement_id'], 'label' => false, 'error' => false, 'div' => false, 'style'=> ' width: 450px;')); ?>
							</td>
						</tr>
						<tr>
							...
							<td align="left" class="score_values">
								<?php				
								echo $this->Form->input('movement_option][',array('type'=>'select', 
																					'class' => 'input optionSelected', 
																					'options' => array('time' => 'Time', 'distance' => 'Distance','load' => 'Load', 'reps' => 'Reps', 'rounds' => 'Rounds'), 
																					'selected' => $wdm['WodMovement']['type'], 
																					'label' => false, 
																					'error' => false, 
																					'div' => false, 
																					'style'=> 'width: 200px;'));
								echo $this->Form->input('option_data][', array('class' => 'input required number','label' => false,'div' => false,'placeholder' => 'value', 'value' => $wdm['WodMovement']['value']) );
								
								$dstyle = $lstyle = '';
								if($wdm['WodMovement']['sub_type'] == 'mile' || $wdm['WodMovement']['sub_type'] == 'meter')
									$dstyle = 'display: none';
								if($wdm['WodMovement']['sub_type'] == 'lbs' || $wdm['WodMovement']['sub_type'] == 'kg')
									$lstyle = 'display: none';
								echo $this->Form->input('movement_distance][',array('type'=>'select', 'class' => 'input distanceOption', 'options' => array('mile' => 'Mile','meter' => 'Meter'), 'selected' => $wdm['WodMovement']['sub_type'] ,'label' => false, 'error' => false, 'div' => false, 'style'=>'width: 70px;'.$dstyle));
								echo $this->Form->input('movement_load][',array('type'=>'select', 'class' => 'input loadOption', 'options' => array('lbs' => 'lbs','kg' => 'Kg'), 'selected' => $wdm['WodMovement']['sub_type'] , 'label' => false, 'error' => false, 'div' => false, 'style'=>'width: 70px;display:none;'.$lstyle)); 
								?>
					...
					<table>
						...
						<tr>
							...
							<td align="left" class="score_values">
								...
								echo $this->Form->input('movement_distance][',array('type'=>'select', 'class' => 'input distanceOption', 'selected' => $data['movement_distance'][$j], 'options' => array('mile' => 'Mile','meter' => 'Meter'), 'label' => false, 'error' => false, 'div' => false, 'style'=>'width: 70px; display:none;'.$dstyle));
